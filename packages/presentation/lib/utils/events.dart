...
class AnalyticsEventType {
  ...
  static const shareButton = 'share-button';
  static const authByLogin = 'auth_by_login';
  static const authByGoogle = 'auth_by_google';
  static const authByFacebook = 'auth_by_fb';
